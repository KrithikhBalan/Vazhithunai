...
- main:
  - group "Language selector":
    - button "English"
    - button "தமிழ்" [pressed]
  - img "Vazhithunai brand mark"
  - heading "வழித்துணை Vazhithunai" [level=1]
  - paragraph: உங்கள் AI பயண துணை
  - text: புத்திசாலி பயண திட்டமிடல் செலவு பகிர்வு குழு பயணம்
  - link "தொடங்குவோம்":
    - /url: /login
  - paragraph: உள்நுழைவதன் மூலம் நீங்கள் எங்கள் பயன்பாட்டு விதிமுறைகளை ஒப்புக்கொள்கிறீர்கள்
- alert
```
