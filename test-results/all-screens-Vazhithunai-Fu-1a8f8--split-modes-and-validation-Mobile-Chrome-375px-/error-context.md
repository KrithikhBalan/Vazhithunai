...
- Name: all-screens.spec.ts >> Vazhithunai Full App DOM Test Suite >> SCR-12: Add Expense form inputs, 4 split modes, and validation
- Location: e2e\all-screens.spec.ts:157:7
...
Locator: locator('#expense-amount-input')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#expense-amount-input')

```

```yaml
- paragraph: Loading trip details…
- navigation:
  - link "Home":
    - /url: /dashboard
  - link "Explore":
